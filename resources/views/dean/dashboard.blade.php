...
@section('page-title', 'Панель модерации')
    ...
    <div class="col-md-3">
        <div class="card border">
            <div class="card-body">
                ...
                <a href="{{ route('moderator.debts') }}" class="text-decoration-none" style="font-size:12px;">Просмотреть</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="card border">
            <div class="card-body">
                ...
                <a href="{{ route('moderator.retakes.index') }}" class="text-decoration-none" style="font-size:12px;">Просмотреть</a>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border">
            <div class="card-body">
                ...
                <a href="{{ route('moderator.requests') }}" class="text-decoration-none" style="font-size:12px;">Рассмотреть</a>
            </div>
        </div>
    </div>
</div>
